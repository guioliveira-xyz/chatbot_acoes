...
# Definir função de pegar histórico de cotação por Ticker. 
...
def gera_texto(mensagens):
    ...
    if tool_calls:
        ...
        for tool_call in tool_calls:
            func_name = tool_call.function.name # pega o nome da função a ser chamada
            function_to_call = funcoes_disponiveis[func_name] # pega o local onde falamos que elas existem
...
if __name__ == '__main__':
    ...
    print('Bem-vindo ao Chat Bot de Ações.')
    while True:
